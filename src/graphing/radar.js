...
const Radar = function (size, radar) {
  ...
  function plotRadarHeader () {
    ...
    header.select('.radar-title')
      ...
      .html('<a href="https://www.mitrais.com"> <img src="images/logo.png" /> </a>')
  ...
  function plotRadarFooter () {
    d3.select('body')
      ...
      'This software is <a href="https://github.com/mitrais/build-your-own-radar">open source</a> and available for download and self-hosting.')
  }
